...
SECRET_KEY = 'django-insecure-!sqjij&clo70j9wbunz$wzc_ubg_=vsx*90wmf$#$-h8ti&&os'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'events' / 'templates'],  # 👈 THIS LINE
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LOGIN_REDIRECT_URL = '/events/'          # 👈 After login go to events
